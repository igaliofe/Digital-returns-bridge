...
תיקייה זו מכילה את צילומי המסך שאליהם מפנים מסמכי ההגשה. **כל 24 הצילומים קיימים.**

14 הצילומים של ממשק ה-`Web` אינם מצולמים ידנית אלא נוצרים מחדש על ידי הרצה אחת:
...
ההרצה משתמשת באותם page objects ובאותן fixtures של חבילת ה-`e2e`, ולכן כל צילום מתועד במצב
המדויק שהטבלאות שלהלן מגדירות — ולא במצב מקרי. `globalSetup` מאתחל את ה-stack ואת נתוני הזריעה
לפני הצילום, כך שההרצה משחזרת את אותן תמונות.

10 הצילומים של אפליקציית ה-`Android` צולמו מאמולטור באמצעות `adb`, לפי אותן הגדרות מצב.
